    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-500 ${
          isScrolled
            ? "bg-[#0c0b0a]/92 backdrop-blur-md py-3 sm:py-3.5 border-b border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.6)]"
            : "bg-transparent py-4 sm:py-5 lg:py-7 border-b border-white/10"
        }`}
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between min-h-[44px]">
          ...
          <div className="hidden lg:flex items-center">
            <a
              ...
              className="relative group inline-flex items-center justify-center px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.22em] text-[#0c0b0a] bg-[#f5f2eb] border border-[#f5f2eb] overflow-hidden transition-all duration-300 hover:border-[#c9a87c]"
            ...
            <div className="flex flex-col gap-6 mt-2">
              ...
              <div className="pt-2 flex flex-col gap-3">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center justify-between w-full p-4 bg-[#f5f2eb] text-[#0c0b0a] font-bold text-xs tracking-[0.2em] uppercase hover:bg-[#c9a87c] transition-colors min-h-[50px] shadow-[0_4px_20px_rgba(245,242,235,0.12)]"
                  style={{ color: "#0c0b0a", backgroundColor: "#f5f2eb" }}
                >
