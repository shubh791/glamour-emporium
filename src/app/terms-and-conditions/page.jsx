    ...
    >
      <div className="space-y-12 sm:space-y-14">
        ...
        <section className="space-y-4 pt-8 border-t border-white/10">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl text-[#f5f2eb] font-normal tracking-tight">
            Commercial &amp; Statutory Identity
          </h2>
          <p className="text-xs sm:text-sm text-[#eae6df]/85">
            Details of the operating enterprise and GST registration:
          </p>
          ...
          <div className="p-5 sm:p-6 bg-white/[0.02] border border-white/10 space-y-4">
            ...
            <div className="pt-3 border-t border-white/10 text-xs text-[#eae6df]/80 font-sans">
              <p className="leading-relaxed">
                <strong className="text-[#f5f2eb]">Glamour Emporium Unisex Salon is operated by SS Enterprises.</strong> All commercial agreements, booking receipts, and salon services are rendered under the entity of SS Enterprises.
              </p>
            </div>
          </div>
        </section>
